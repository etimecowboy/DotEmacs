...
(defun color-theme-wombat+ ()
  ...
  (color-theme-install
   '(color-theme-wombat+
     ...
     (default ((t (:stipple nil :background "#242424" :foreground "#f6f3e8" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width normal))))
     ...
     (compilation-info ((t (:inherit find-lock-function-face :weight bold))))
