...
(defun color-theme-active ()
  ...
  (color-theme-install
   '(color-theme-active
     ...
     (dired-perm-write ((t (:family "Terminus" :foundry "outline" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :stipple nil :height 120))))
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "#009933"))))
     (font-lock-comment-face ((t (:foreground "#009933"))))
