...
(setq ansit-color-black         "[1;30m")
(setq ansit-color-red           "[1;31m")
(setq ansit-color-green         "[1;32m")
(setq ansit-color-yellow        "[1;33m")
(setq ansit-color-blue          "[1;34m")
(setq ansit-color-magenta       "[1;35m")
(setq ansit-color-cyan          "[1;36m")
(setq ansit-color-white         "[1;37m")

(setq ansit-builtin-color       "[1;35m")
(setq ansit-comment-color       "[1;35m")
(setq ansit-constant-color      "[1;31m")
(setq ansit-doc-color           "[1;35m")
(setq ansit-function-name-color "[1;34m")
(setq ansit-keyword-color       "[1;34m")
(setq ansit-preprocessor-color  "[1;35m")
(setq ansit-string-color        "[1;35m")
(setq ansit-type-color          "[1;32m")
(setq ansit-variable-name-color "[1;33m")
(setq ansit-warning-color       "[1;31m")

(defvar ansit-result-string ""
  "Do not set this variable.")

(defalias 'ansit 'ansit-ansify-this)
(defun ansit-ansify-this ()
  "Fontify region between mark and point, add the result to kill ring."
  (interactive)
  (kill-new (ansit-ansify-region (mark) (point))))
    ...
    (unless (= beg end)
      (save-excursion
        ...
        (while (< (point) end)
          ...
          (unless tmp
            (setq tmp end))
          ;; no cross-line properties unless in block comment
          (setq tface (get-text-property (point) 'face))
          (when (listp tface)
            (setq tface (car tface)))
          (setq tface (not (eq tface font-lock-warning-face)))
          (when (and (> tmp (line-end-position)) tface)
          ...
          (cond
           ...
           ((eq tface font-lock-comment-delimiter-face)
            (setq color ansit-comment-color))
